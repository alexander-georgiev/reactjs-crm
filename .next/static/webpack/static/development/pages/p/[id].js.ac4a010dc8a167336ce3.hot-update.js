...
class Article extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  componentDidMount() {
    const ref = _Firebase__WEBPACK_IMPORTED_MODULE_3__["default"].firestore().collection('boards').doc(this.props.match.params.id);
    ref.get().then(doc => {
      if (doc.exists) {
        this.setState({
          board: doc.data(),
...
//# sourceMappingURL=[id].js.ac4a010dc8a167336ce3.hot-update.js.map