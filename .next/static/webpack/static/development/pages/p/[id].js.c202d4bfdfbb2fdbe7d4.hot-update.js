...
class Article extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "onCollectionUpdate", querySnapshot => {
      ...
      _Firebase__WEBPACK_IMPORTED_MODULE_2__["default"].firestore().collection('articles').where('title', '==', id).get().then(function (querySnapshot) {
...
//# sourceMappingURL=[id].js.c202d4bfdfbb2fdbe7d4.hot-update.js.map