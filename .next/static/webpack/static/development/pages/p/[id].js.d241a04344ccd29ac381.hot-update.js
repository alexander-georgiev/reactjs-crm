...
class Article extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  componentDidMount() {
    const id = this.props.url.query.id;
    const self = this;
    const ref = _Firebase__WEBPACK_IMPORTED_MODULE_3__["default"].firestore().collection('articles').where('title', '==', id).get().then(function (querySnapshot) {
      querySnapshot.forEach(function (doc) {
        var obj = doc.data();
        obj['id'] = doc.id;
        self.setState({
...
//# sourceMappingURL=[id].js.d241a04344ccd29ac381.hot-update.js.map