...
class Article extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  componentDidMount() {
    const id = this.props.url.query.id;
    const ref = _Firebase__WEBPACK_IMPORTED_MODULE_3__["default"].firestore().collection('articles').doc(this.props.match.params.id);
    ref.get().then(doc => {
      if (doc.exists) {
        this.setState({
          board: doc.data(),
...
//# sourceMappingURL=[id].js.6bf298a3f644025009ce.hot-update.js.map