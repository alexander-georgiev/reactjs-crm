...
class Articles extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  componentDidMount() {
    const ref = _Firebase__WEBPACK_IMPORTED_MODULE_2__["default"].firestore().collection('boards').doc(this.props.match.params.id);
    ref.get().then(doc => {
      if (doc.exists) {
        this.setState({
          board: doc.data(),
...
//# sourceMappingURL=[id].js.2e3d45852a6f0689d8b1.hot-update.js.map