...
Post.getInitialProps = async function (context) {
  ...
  const res = _Firebase__WEBPACK_IMPORTED_MODULE_2__["default"].firestore().collection(collection).where('title', '==', self.$route.params.id).get().then(function (querySnapshot) {
...
//# sourceMappingURL=[id].js.2384e84c7be63bcfbad2.hot-update.js.map