...
Post.getInitialProps = async function (context) {
  ...
  const res = _Firebase__WEBPACK_IMPORTED_MODULE_2__["default"].firestore().collection('articles').where('title', '==', self.$route.params.id).get().then(function (querySnapshot) {
...
//# sourceMappingURL=[id].js.c87f3783b6eaed89ec39.hot-update.js.map